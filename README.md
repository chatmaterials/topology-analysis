...
Standalone skill for topological-material post-processing, candidate ranking, and report generation.
...
python3 scripts/compare_topology_candidates.py fixtures fixtures/candidates/trivial --json
